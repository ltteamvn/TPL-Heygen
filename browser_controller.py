...
class BrowserAutomationController:
    ...
    def analyze_srt(self, srt_content: str, n_keywords: int, custom_prompt: str = "") -> List[Dict]:
        ...
        prompt = (
            ...
            f"3. TỐI ƯU HÓA PROMPT CHO TIẾNG VIỆT (NẾU SRT TIẾNG VIỆT):\n"
            f"   - Nếu tệp phụ đề SRT là ngôn ngữ tiếng Việt, bắt buộc các câu prompt tiếng Anh mô tả bối cảnh tạo ảnh phải thuần Việt Nam (ví dụ: người Việt Nam, trang phục Việt Nam, phong cảnh/đường phố Việt Nam).\n"
            f"   - Đặc biệt, nếu trên hình ảnh cần có chữ viết/văn bản (text), chữ viết đó bắt buộc phải hiển thị bằng TIẾNG VIỆT CÓ DẤU (ví dụ: mô tả rõ 'The text \"HÀNG TƯƠI SỐNG\" is clearly written in Vietnamese on the sign...'). Không dùng chữ tiếng Anh nếu SRT là tiếng Việt.\n\n"
